...
public class EditarCliente extends javax.swing.JPanel {
     ...
     */
    public EditarCliente(JPanel panelPagina, List<Cliente> clientes, Empleado emp, int id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(botonEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 430, 150, 30));
