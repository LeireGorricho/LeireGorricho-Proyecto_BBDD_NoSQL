...
public class NuevoLibro extends javax.swing.JPanel {
     ...
     */
    public NuevoLibro(JPanel panelPagina, Empleado emp) {
        initComponents();
    ...
    private void botonAnadirMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonAnadirMousePressed
        try {
            ...
            if (titulo.getText().isBlank() || autor.getText().isBlank() || genero.getText().isBlank() || editorial.getText().isBlank() || idioma.getText().isBlank() || numPaginas.getText().isBlank()){
                ...
                Libro nuevolibro = new Libro(id, titulo.getText(), autor.getText(), genero.getText(), editorial.getText(), idioma.getText(), numeropaginas);
                conexion.anadirLibro(nuevolibro, emp);
